...
public class ProfileControllerTest extends ControllerTest {
    ...
    public void setupService() {
		...
		rsp.put(1, new UserRec("one@count.com", "first", "last", "asdfasdfasdfasdgd", 20, true, 1, place, ints.toArray(new Interest[0])));
		
		ints.clear();
		ints.add(new Interest("Homebrewing"));
		ints.add(new Interest("Lego building"));
		ints.add(new Interest("Woodworking"));
		rsp.put(2, new UserRec("two@count.com", "second", "last", "asdfafffr23asdgd", 85, true, 2, place, ints.toArray(new Interest[0])));
